...
import UnsubscribeRateCalculatorTool from "@/components/site/UnsubscribeRateCalculatorTool";

export const metadata: Metadata = {
  title: "Free Unsubscribe Rate Calculator | UPPR Agency",
  description: "Calculate your unsubscribe rate and compare it against industry benchmarks — free, no signup required.",
};
...
export default function UnsubscribeRateCalculatorPage() {
  return (
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <header style={{ maxWidth: 700, margin: "0 auto", padding: "clamp(120px,18vw,170px) clamp(18px,5vw,28px) clamp(40px,6vw,60px)", textAlign: "center" }}>
          ...
          <p style={{ margin: 0, fontSize: 15.5, lineHeight: 1.6, color: "#A29DB8" }}>
            Introdu cifrele unei campanii — vezi rata reală și cum se compară cu benchmark-ul de industrie.
          </p>
        </header>

        <main style={{ maxWidth: 620, margin: "0 auto", padding: "0 clamp(18px,5vw,28px) clamp(100px,14vw,140px)" }}>
          <UnsubscribeRateCalculatorTool />
        </main>
